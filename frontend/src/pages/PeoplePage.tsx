  ...
  return (
    <>
      <SEO 
        ...
        description="Explore the fascinating characters from the Star Wars universe. Learn about their stories, origins, and connections to the galaxy far, far away."
      />
      <Box>
        <Typography
          variant="h4"
